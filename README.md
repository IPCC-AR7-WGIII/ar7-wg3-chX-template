...
- `figXX.XX`: The `figXX.XX/` folder is the main location for storing figure information. It contains three subfolders: data/, code/, and figure/, which are described below. You should duplicate the folder (including subfolders) for each figure in the chapter and name it accordingly (e.g., fig1, fig2, box1fig1).  
